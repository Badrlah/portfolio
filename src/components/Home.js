    ...
    <motion.span key={index} variants={childVariants}>
      {letter}
          ...
          <div>
            ...
            <a className="btn btn-dark p-2" href="#contact" >Contact Info</a>
          </div>
          <div className="social-icons mt-3">
            <a href="https://www.linkedin.com/in/badreddine-lahlaissi-4235b032a/" target="_blank" rel="noopener noreferrer">
